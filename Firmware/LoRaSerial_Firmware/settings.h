...
typedef struct struct_settings {
  ...
  uint8_t netID = 191; //Both radios must share a network ID
  uint8_t operatingMode = MODE_MULTIPOINT; //Receiving unit will check netID and ACK. If set to false, receiving unit doesn't check netID or ACK.
