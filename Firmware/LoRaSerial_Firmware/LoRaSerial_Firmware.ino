...
#define ENABLE_WDT          //Enable the watch-dog timer
...
void setup()
{
  //Request waiting for the serial port to enable early debug output
  #ifdef  ENABLE_DEVELOPER
    settings.usbSerialWait = true;
  ...
  systemPrintln("Sprinkler Controller");
