...
bool commandAT(const char * commandString)
{
  ...
  if (commandString[2] == 'I' && commandLength == 4)
  {
    switch (commandString[3])
    {
      ...
      case ('?'): //ATI? - Display the information commands
        ...
        //Sprinkler controller information commands
  ...
  //ATI9x
  if ((commandString[2] == 'I') && (commandString[3] == '9') && (commandLength == 5))
  {
    switch (commandString[4])
    {
      default:
      ...
      case ('9'): //ATI99 - Product description
        systemPrintln("Makakilo Hale II Sprinkler Controller");
        return true;
    }
  }
